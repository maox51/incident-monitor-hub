...
-- Actualizar la función obtener_consolidado_con_medios para filtrar solo incidencias aprobadas
...
-- Actualizar la función generar_reporte_consolidado para contar solo incidencias aprobadas
