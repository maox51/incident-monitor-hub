...
DROP POLICY IF EXISTS "Usuarios autenticados pueden ver salas" ON public.salas;
DROP POLICY IF EXISTS "Solo administradores pueden modificar salas" ON public.salas;
DROP POLICY IF EXISTS "Usuarios autenticados pueden ver clasificacion_area" ON public.clasificacion_area;
DROP POLICY IF EXISTS "Solo administradores pueden modificar clasificacion_area" ON public.clasificacion_area;
DROP POLICY IF EXISTS "Usuarios autenticados pueden ver clasificacion_area_mapping" ON public.clasificacion_area_mapping;
DROP POLICY IF EXISTS "Solo administradores pueden modificar clasificacion_area_mapping" ON public.clasificacion_area_mapping;

-- Habilitar RLS en tablas que faltan (solo si no está habilitado)
