...
export function AppSidebar({ activeTab, onTabChange }: AppSidebarProps) {
  ...
  const menuItems = [
    ...
    { id: 'movimiento-activos', label: 'Movimiento de Activos', icon: Package, roles: ['admin', 'finanzas', 'monitor','gestor_solicitudes'] },
    { id: 'billeteros', label: 'Billeteros', icon: CreditCard, roles: ['admin', 'finanzas', 'monitor', 'gestor_solicitudes'] },
    { id: 'consolidado', label: 'Consolidado Diario', icon: Calendar, roles: ['admin', 'rrhh', 'supervisor_monitoreo', 'supervisor_salas', 'finanzas', 'mantenimiento', 'lector'] },
    { id: 'reportes', label: 'Reportes', icon: FileText, roles: ['admin', 'rrhh', 'supervisor_monitoreo', 'supervisor_salas', 'finanzas', 'mantenimiento', 'lector'] },
