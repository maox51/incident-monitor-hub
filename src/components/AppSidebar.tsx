...
export function AppSidebar({ activeTab, onTabChange }: AppSidebarProps) {
  ...
  const menuItems = [
    ...
    { id: 'movimiento-activos', label: 'Movimiento de Activos', icon: Package, roles: ['admin', 'supervisor_monitoreo', 'rrhh', 'finanzas', 'monitor','gestor_solicitudes'] },
    { id: 'billeteros', label: 'Billeteros', icon: CreditCard, roles: ['admin', 'supervisor_monitoreo', 'rrhh', 'finanzas', 'monitor', 'gestor_solicitudes'] },
