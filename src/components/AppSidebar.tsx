...
export function AppSidebar({ activeTab, onTabChange }: AppSidebarProps) {
  ...
  const menuItems = [
    ...
    { id: 'gestion-pagos', label: 'Gestión de Pagos', icon: CreditCard, roles: ['admin', 'supervisor_monitoreo', 'monitor', 'rrhh', 'finanzas', 'mantenimiento', 'gestor_solicitudes'] },
    { id: 'pagos724', label: 'Pagos 724', icon: DollarSign, roles: ['admin', 'supervisor_monitoreo', 'monitor', 'rrhh', 'finanzas'] },
